...
impl CanaryController {
    pub fn new(stable: Vec<VersionedWorker>, canary: Vec<VersionedWorker>, canary_pct: f64, error_threshold_pct: f64) -> Self {
        Self { stable, canary, canary_pct, error_threshold_pct, canary_errors: 0, canary_total: 0 }
    }
    ...
    pub fn route_to_canary(&self, request_index: u64) -> bool {
        ...
        if self.canary_pct <= 0.0 { return false; }
