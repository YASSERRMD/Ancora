...
pub fn ecosystem_index() -> Vec<IndexEntry> {
    vec![
        ...
        IndexEntry::new(
            "Changelog",
            "changelog",
            "Version history and change categories",
        ),
        IndexEntry::new(
            "Quickstart",
            "quickstart",
            "Extension author getting-started guide",
        ),
        IndexEntry::new(
            "Registry Links",
            "registry_links",
            "Registry and catalog documentation links",
        ),
        IndexEntry::new(
            "Trust Summary",
            "trust_summary",
