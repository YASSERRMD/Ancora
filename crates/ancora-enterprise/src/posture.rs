...
impl SecurityPosture {
    ...
    pub fn get_domain(&self, name: &str) -> Option<&DomainScore> {
        self.domain_scores.get(name)
    }
    pub fn domains(&self) -> impl Iterator<Item = &DomainScore> {
        self.domain_scores.values()
    }
}
