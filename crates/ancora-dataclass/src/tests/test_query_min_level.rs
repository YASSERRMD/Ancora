...
fn query_min_level_filters_correctly() {
    ...
    reg.insert(DataRecord::new("r1", "t1", "x", SensitivityLevel::Public, DataCategory::Generic, 0)).unwrap();
    reg.insert(DataRecord::new("r2", "t1", "y", SensitivityLevel::Restricted, DataCategory::Generic, 0)).unwrap();
