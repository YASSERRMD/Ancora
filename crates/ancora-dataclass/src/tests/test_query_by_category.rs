...
fn query_by_category() {
    ...
    reg.insert(DataRecord::new("r1", "t1", "x", SensitivityLevel::Internal, DataCategory::Pii, 0)).unwrap();
    reg.insert(DataRecord::new("r2", "t1", "y", SensitivityLevel::Internal, DataCategory::Financial, 0)).unwrap();
