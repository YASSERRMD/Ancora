...
fn boundary_add_and_get() {
    ...
    b.add_zone(AirGapZone::new("z1", "Zone 1", ZoneClassification::Internal, "t1"));
...
fn boundary_for_tenant() {
    let mut b = AirGapBoundary::new();
    b.add_zone(AirGapZone::new("z1", "Z1", ZoneClassification::Internal, "t1"));
    b.add_zone(AirGapZone::new("z2", "Z2", ZoneClassification::Internal, "t2"));
