...
fn report_audit_entries() {
    ...
    a.record(AirGapAuditEntry::new(1, "t1", AirGapAction::TransferRequested, "alice", ""));
    a.record(AirGapAuditEntry::new(2, "t1", AirGapAction::TransferApproved, "bob", ""));
...
fn report_restricted_zone_count() {
    ...
    b.add_zone(AirGapZone::new("z1", "Z1", ZoneClassification::TopSecret, "t1"));
    b.add_zone(AirGapZone::new("z2", "Z2", ZoneClassification::Restricted, "t1"));
    b.add_zone(AirGapZone::new("z3", "Z3", ZoneClassification::Public, "t1"));
    let s = TransferStore::new();
...
fn report_pending_transfers() {
    ...
    let req1 = TransferRequest::new("r1", "t1", "alice", MediaType::UsbDrive, TransferDirection::Inbound, "", 1);
    let mut req2 = TransferRequest::new("r2", "t1", "alice", MediaType::CdRom, TransferDirection::Inbound, "", 1);
    req2.approve(5);
    s.insert(req1);
    s.insert(req2);
    let a = AirGapAuditLog::new();
