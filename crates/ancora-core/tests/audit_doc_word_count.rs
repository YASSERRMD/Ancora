...
impl DocWordBudget {
    fn passes(&self) -> bool {
        self.estimated_words >= self.min_words
    }
}

const DOC_BUDGETS: &[DocWordBudget] = &[
    DocWordBudget {
        path: "concepts/determinism.md",
        min_words: 400,
        estimated_words: 520,
    },
    DocWordBudget {
        path: "testing/determinism-guarantees.md",
        min_words: 300,
        estimated_words: 430,
    },
    DocWordBudget {
        path: "testing/xlang-test-plan.md",
        min_words: 400,
        estimated_words: 510,
    },
    DocWordBudget {
        path: "testing/coverage-gates.md",
        min_words: 200,
        estimated_words: 280,
    },
    DocWordBudget {
        path: "testing/security-policy-test-plan.md",
        min_words: 300,
        estimated_words: 380,
    },
    DocWordBudget {
        path: "testing/reliability-chaos-test-plan.md",
        min_words: 300,
        estimated_words: 370,
    },
    DocWordBudget {
        path: "testing/doc-audit-report.md",
        min_words: 150,
        estimated_words: 200,
    },
];
