    ...
    let events = vec![
        ...
        JournalEvent {
            ...
            event: Some(Event::ActivityRecorded(ActivityRecordedEvent {
                activity_key: "canonical-step".into(),
                activity_kind: "compute".into(),
                input_json: r#"{"x":1}"#.into(),
                result_json: r#"{"y":2}"#.into(),
                replayed: false,
            })),
        },
        JournalEvent {
...
#[test]
fn canonical_json_stable_across_two_generations() {
