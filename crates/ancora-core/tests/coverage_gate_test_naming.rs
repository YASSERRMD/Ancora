...
fn module_prefix_from_filename(filename: &str) -> &str {
    if filename.starts_with("det_") {
        "det_"
    } else if filename.starts_with("chaos_") {
        "chaos_"
    } else if filename.starts_with("load_") {
        "load_"
    } else if filename.starts_with("reliability_") {
        "reliability_"
    } else if filename.starts_with("sec_") {
        "sec_"
    } else if filename.starts_with("policy_") {
        "policy_"
    } else if filename.starts_with("coverage_gate_") {
        "coverage_gate_"
    } else if filename.starts_with("xlang_") {
        "xlang_"
    } else if filename.starts_with("vector_") {
        "vector_"
    } else {
        "unknown_"
    }
...
fn test_policy_prefix_extracted() {
    assert_eq!(
        module_prefix_from_filename("policy_data_residency"),
        "policy_"
    );
}
