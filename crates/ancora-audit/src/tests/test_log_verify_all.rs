...
fn verify_all_passes_on_clean_log() {
    ...
    log.append(AuditEntry::new(0, 1, "t1", "alice", "login", "auth", Outcome::Success, Severity::Info));
    log.append(AuditEntry::new(0, 2, "t1", "bob", "logout", "auth", Outcome::Success, Severity::Info));
