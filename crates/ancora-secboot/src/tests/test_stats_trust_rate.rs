use crate::{AttestationLog, AttestationRecord, AttestationStatus, BootChain, BootStats, Measurement, MeasurementKind};
#[test]
fn trust_rate_calculated_correctly() {
    ...
    attest.record(AttestationRecord::new("a2", "t1", "n1", AttestationStatus::Untrusted, "q", 0));
