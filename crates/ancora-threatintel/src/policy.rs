...
impl ThreatPolicy {
    ...
    pub fn block_threshold(mut self, t: f64) -> Self {
    ...
    pub fn evaluate(&self, score: &ThreatScore) -> PolicyDecision {
        ...
        if score.raw_score >= self.block_threshold {
            PolicyDecision::Block
        } else if score.raw_score >= self.alert_threshold {
            PolicyDecision::Alert
        } else if score.raw_score > 0.0 {
