...
fn for_scenario_filters() {
    ...
    log.record(step("s1", "sc1", AttackVector::Network, AttackOutcome::Success));
    log.record(step("s2", "sc2", AttackVector::Local, AttackOutcome::Failure));
...
fn successful_filters() {
    let mut log = AttackLog::new();
    log.record(step("s1", "sc1", AttackVector::Network, AttackOutcome::Success));
    log.record(step("s2", "sc1", AttackVector::Network, AttackOutcome::PartialSuccess));
    log.record(step("s3", "sc1", AttackVector::Network, AttackOutcome::Failure));
...
fn detected_filters() {
    let mut log = AttackLog::new();
    log.record(step("s1", "sc1", AttackVector::Network, AttackOutcome::Detected));
    log.record(step("s2", "sc1", AttackVector::Network, AttackOutcome::Success));
...
fn by_vector_filters() {
    let mut log = AttackLog::new();
    log.record(step("s1", "sc1", AttackVector::Network, AttackOutcome::Success));
    log.record(step("s2", "sc1", AttackVector::Local, AttackOutcome::Success));
