...
pub fn priv_esc_scenario(
    ...
    RedTeamScenario::new(
        ...
        ScenarioKind::PrivilegeEscalation,
        tick,
    )
    .with_mitre("TA0004")
}

pub fn lateral_movement_scenario(
    id: impl Into<String>,
    tenant_id: impl Into<String>,
    tick: u64,
) -> RedTeamScenario {
...
pub fn standard_objectives(scenario_id: impl Into<String> + Clone) -> ObjectiveTracker {
    ...
    tracker.add(RedTeamObjective::new(
        "obj-1",
        scenario_id.clone(),
