...
impl IncidentBuilder {
    ...
    pub fn build(self) -> Incident {
        Incident::new(self.id, self.tenant_id, self.title, self.severity, self.tick)
    }
}
...
impl RunbookBuilder {
    pub fn new(id: impl Into<String>, name: impl Into<String>, incident_id: impl Into<String>) -> Self {
        Self { id: id.into(), name: name.into(), incident_id: incident_id.into(), steps: Vec::new() }
    }

    pub fn step(mut self, id: impl Into<String>, title: impl Into<String>, desc: impl Into<String>) -> Self {
    ...
    pub fn build(self) -> Runbook {
        ...
        for step in self.steps { rb.add_step(step); }
        rb
    }
}
